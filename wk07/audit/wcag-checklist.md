...
| Criterion | Level | Status | Evidence | Notes |
|-----------|-------|--------|----------|-------|
| 2.1.1 Keyboard | A | ⚠️ Partial | Almost all features accessible via Tab/Enter/Space, can't use links | Tested: add, edit, delete, cancel |
...
| 2.4.7 Focus Visible | AA | ✅ Pass | Pico.css default outline visible |  |
...
| 4.1.3 Status Messages | AA | ✅ Pass | `<div role="status" aria-live="polite">` | Tested with VoiceOver |
...
2. **2.1.1 Keyboard (A, Partial)**: Make sure users navigating via the keyboard can click on links
